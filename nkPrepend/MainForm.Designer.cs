...
namespace nkPrepend
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.fileListView.ItemDrag += new System.Windows.Forms.ItemDragEventHandler(this.OnFileListViewItemDrag);
			this.fileListView.DragEnter += new System.Windows.Forms.DragEventHandler(this.OnFileListViewDragEnter);
			// 
